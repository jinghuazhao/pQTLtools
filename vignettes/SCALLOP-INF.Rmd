...
This is the actual script for cis-pQTL colocalisation analysis for SCALLOP-INF. The driver is in Bash.
...
collect <- function()
{
  ...
  df_coloc <- within(dr_coloc,{qtl_id <- gsub("GTEx_V8_","",qtl_id)}) %>%
...
```
where it can be seen that there are options for microarray, RNA-Seq and with respect to the gene regions.
