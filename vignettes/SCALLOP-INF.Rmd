...
SF <- function(rxc, f="SF-pQTL-GWAS.png", ch=21, cw=21, h=13, w=18, ylab="Immune-mediated outcomes")
{
  library(pheatmap)
  ...
  grid.text("pQTL (gene)", y=0.03125, gp=gpar(fontsize=12))
  grid.text(ylab, x=-0.0625, rot=90, gp=gpar(fontsize=12))
  dev.off()
}
...
rxc <- gwas()
SF(rxc,f="SF-pQTL-GWAS.png",ch=8,cw=8,h=11,w=8.6,ylab="GWAS traits and diseases")
```
...
This is the actual script for cis-pQTL colocalization analysis on GTEx v8, as reported in @kerimov21, for SCALLOP-INF. 
