...
```
and it is more appropriate to make all p values to be a string varible so they can be easily
handled as follows,
```r
...
```
One can derive logpvalue for natural base (e) similarly.
...
In all three cases, a log10(P) counterpart is obtained internally and to accommodate extreme log10(P),
the y-axis allows for truncation levaing out a given range of log10(P).
