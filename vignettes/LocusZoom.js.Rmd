...
library(htmltools)
lz <- tags$iframe(src = "ACE.html", width = "100%", height = "1500px")
lz
```
...
- `lz.html`,  <https://jinghuazhao.github.io/pQTLtools/articles/lz.htm;>.
- `ACE.html`, <https://jinghuazhao.github.io/pQTLtools/articles/ACE.htm;>.
