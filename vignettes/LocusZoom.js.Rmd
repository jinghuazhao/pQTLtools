...
The direct link for `lz.htm` is <https://jinghuazhao.github.io/pQTLtools/articles/lz.htm>.
...
We set to change filename and region dynamically, as is shown with A1BG-rs145685027.json above.

```{r, results='asis', echo=FALSE}
library(htmltools)
filename <- "A1BG-rs145685027"
chr <- "19"
start <- 58948122 - 25000
end <- 58948122 + 25000
html_content <- readLines("ACE.htm")
...
lz <- tags$iframe(src = output_html, width = "100%", height = "1500px")
lz
```

Lastly, the direct link for `ACE.htm` is <https://jinghuazhao.github.io/pQTLtools/articles/ACE.htm>.
