...
It is preferable though to change filename and region dynamically, as is shown with A1BG-rs145685027.json above.

```{r, results='asis', echo=FALSE}
library(htmltools)
filename <- "A1BG-rs145685027.json"
chr <- "19"
start <- 58948122 - 25000
end <- 58948122 + 25000
html_content <- readLines("ACE.htm")
html_content <- gsub("ACE-rs4353.json", filename, html_content)
...
lz <- tags$iframe(src = temp_html, width = "100%", height = "1500px")
lz
```
