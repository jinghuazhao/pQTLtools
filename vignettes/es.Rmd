...
text(y=ytick, par("usr")[3],labels = prot, srt = 25, pos = 1, xpd = TRUE, cex=0.4)
mtext("100-% samples with very low abundance per protein",side=1,line=2.5,cex=1.2)
mtext("Ordered protein",side=2,line=2.5,cex=0.9,font=2)
legend(x=75,y=15,c("without pQTL","with pQTL"),box.lwd=0,cex=1.2,col=c("red","blue"),pch=19)
detach(annot)
options(width=120)
