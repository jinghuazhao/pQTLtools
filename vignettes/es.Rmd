...
Finally, quality metrics as with linear models for differential expression and enrichment analysis are illustrated by the Bioconductor `maEndtoEnd` package.
