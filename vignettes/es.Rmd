...
par(mar=c(5,4,1,1))
attach(annot)
plot(100-pc.belowLOD.new,cex=0.8,pch=19,col=pQTL,axes=FALSE, xlab="", ylab="", cex.lab=0.8)
...
mtext("100 - % samples with very low abundance per protein",side=2,line=2.5,cex=1.2)
mtext("Ordered proteins",side=1,line=2.5,cex=0.9,font=2)
