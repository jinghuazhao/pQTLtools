...
```{r ct_plot, fig.cap="Bar chart and circos plot", fig.height=7, fig.width=7}
...
The plot is based on target gene (encoding proteins) and somewhat too busy, so we examine the *SH2B3*.
