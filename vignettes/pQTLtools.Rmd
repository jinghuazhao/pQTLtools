...
exposure <- TwoSampleMR::format_data(within(d,{P=10^logP}), phenotype_col="prot", snp_col="rsid",
                        ...
                        samplesize_col="N")
clump <- exposure[sample(1:nrow(exposure),nrow(exposure)/40),] # TwoSampleMR::clump_data(exposure)
...
At time of running (12/4/2024), `clump_data` fails to run so 2.5% variants is used for illustrative purpose.
