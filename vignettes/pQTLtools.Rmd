...
Function `clump_data` requires a two-week authentication but 1.25% variants is used for illustrative purpose.

The output is contained in individual `.txt` files, together with the scatter, forest, funnel and leave-one-out plots.

```{r mmp10, fig.cap="MMP.10 and FEV1", fig.height=8, fig.width=9, results='hide', warning=FALSE}
