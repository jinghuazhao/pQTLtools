...
can be used together for conducting MR with a list of outcomes from MR-Base. For generic
use the `run_TwoSampleMR()` function can be used.

```{r, warning=FALSE}
library(TwoSampleMR)
f <- file.path(find.package("pQTLtools",lib.loc=.libPaths()),"tests","Ins.csv")
ins <- format_data(read.csv(f))
