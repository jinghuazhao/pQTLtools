...
```{r, echo=FALSE}
sapply(c("result","heterogeneity","pleiotropy","single","loo"), function(x)
       knitr::kable(read.delim(paste0(prefix,"-",x,".txt"),header=TRUE),caption=paste0("MMP.10 variants and FEV1 (",x,")"))
)
```

```{r, echo=FALSE}
sapply(c("result","heterogeneity","pleiotropy","single","loo"), function(x) unlink(paste0(prefix,"-",x,".txt")))
```
