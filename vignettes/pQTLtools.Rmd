...
## pQTL-based Mendelian Randomization
...
run_TwoSampleMR(exposure.args=e(d),outcome.args=extract_outcome_data.args(outcomes=outcomes),
                clump.args=clump_data.args(),harmonise.args=harmonise_data.args(),prefix=prefix)
invisible(sapply(c("result","heterogeneity","pleiotropy","single","loo"), function(x) unlink(paste0(prefix,"-",x,".txt"))))
if(file.exists(paste0(prefix,".pdf")))
{
  knitr::include_graphics(paste0(prefix,".pdf"))
  unlink(paste0(prefix,".pdf"))
}
```
