...
t2d <- mhtplot2d(d)
```
whose result can be also viewed in a plotly style,
```{r plotly, fig.height=8, fig.width=8, plotly=TRUE}
library(plotly)
fig <- mhtplot3d(xyz=file.path(INF,"work","INF1.merge.cis.vs.trans"),
...
# htmlwidgets::saveWidget(fig,file="fig.html")
```
