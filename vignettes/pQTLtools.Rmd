...
```{r qtl2dplotly, echo=FALSE, fig.cap="2d pQTL plotly", fig.height=8, fig.width=8, results="asis", plotly=TRUE}
fig2d <- qtl2dplotly(cis.vs.trans,xlab="pQTL position",ylab="Gene position")
fig2d
# htmlwidgets::saveWidget(fig2d,file="fig2d.html")
```
and 3-d counterpart
```{r qtl3dplotly, echo=FALSE, fig.cap="3d pQTL plotly", fig.height=8, fig.width=8, results="asis", plotly=TRUE}
