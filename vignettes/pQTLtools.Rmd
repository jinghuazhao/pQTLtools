...
As `clump_data` requires a somewhat confusing authentication token, 

- 1.25% variants is used for illustrative purpose.
- `extract_outcome_data` is unused (`outcome <- TwoSampleMR::extract_outcome_data(snps=clump$SNP,outcomes="ebi-a-GCST007432")`).
