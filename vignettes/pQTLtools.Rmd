...
```{r qtl2dplotly, echo=FALSE, fig.cap="2d pQTL plotly", fig.height=8, fig.width=8, plotly=TRUE}
...
```{r qtl3dplotly, echo=FALSE, fig.cap="3d pQTL plotly", fig.height=8, fig.width=8, plotly=TRUE}
