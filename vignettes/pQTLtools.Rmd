...
knitr::kable(result,caption="Table 2. ABO/LIFR variants and CHD/FEV1 (result)")
single <- read.delim("pQTL-combined-single.txt",header=TRUE)
knitr::kable(subset(single,!grepl("All",SNP)),
             caption="Table 2. ABO/LIFR variants and CHD/FEV1 (single)")
...
```{r, echo=FALSE}
knitr::kable(read.delim(paste0(prefix,"-result.txt"),header=TRUE),caption="Table 3. MMP.10 variants and FEV1 (result)")
knitr::kable(read.delim(paste0(prefix,"-heterogeneity.txt"),header=TRUE),caption="Table 3. MMP.10 variants and FEV1 (heterogeneity)")
knitr::kable(read.delim(paste0(prefix,"-pleiotropy.txt"),header=TRUE),caption="Table 3. MMP.10 variants and FEV1 (pleiotropy)")
knitr::kable(read.delim(paste0(prefix,"-single.txt"),header=TRUE),caption="Table 3. MMP.10 variants and FEV1 (single)")
knitr::kable(read.delim(paste0(prefix,"-loo.txt"),header=TRUE),caption="Table 3. MMP.10 variants and FEV1 (loo)")
