...
while maintaining greater flexibility, steps are done a priori for a harmonised data as is
illustrated below.
...
knitr::kable(ins, caption=paste(caption2,"(instruments)"))
...
```{r, fig.height=6, fig.width=7, results='hide',warning=FALSE}
library(TwoSampleMR)
...
```{r, echo=FALSE}
caption3 <- "Table 3. MMP.10 variants and FEV1"
knitr::kable(read.delim(paste0(prefix,"-result.txt"),header=TRUE),caption=paste(caption3, "(result)"))
knitr::kable(read.delim(paste0(prefix,"-heterogeneity.txt"),header=TRUE),caption=paste(caption3,"(heterogeneity)"))
knitr::kable(read.delim(paste0(prefix,"-pleiotropy.txt"),header=TRUE),caption=paste(caption3,"(pleiotropy)"))
knitr::kable(read.delim(paste0(prefix,"-single.txt"),header=TRUE),caption=paste(caption3,"(single)"))
knitr::kable(read.delim(paste0(prefix,"-loo.txt"),header=TRUE),caption=paste(caption3,"(loo)"))
