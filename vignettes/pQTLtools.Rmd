...
invisible(sapply(c("result","heterogeneity","pleiotropy","single","loo"), function(x)
{
  r <- read.delim(paste0(prefix,"-",x,".txt"),header=TRUE)
  knitr::kable(r,caption=paste0("Table 3. MMP.10 variants and FEV1 (",x,")"))
