...
- use 1.25% variants instead of `clump_data` is used for illustrative purpose.
- avoid `extract_outcome_data` (`outcome <- TwoSampleMR::extract_outcome_data(snps=clump$SNP,outcomes="ebi-a-GCST007432")`).
