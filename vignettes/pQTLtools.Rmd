...
```{r TwoSampleMR, fig.cap="Two-sample MR", fig.height=6, fig.width=9, results='hide', warning=FALSE}
prot <- "MMP.10"
type <- "cis"
...
```{r mmp10, fig.cap="MMP.10 and FEV1", fig.height=6, fig.width=9, results='hide', warning=FALSE}
