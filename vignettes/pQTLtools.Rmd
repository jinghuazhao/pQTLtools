...
We start with a positive control using Osteoprotegerin (OPG) @kwan14,
...
involving a cis and a trans pQTLs, respectively.

As `meta` inherently includes random effects, we specifically select a fixed effects (FE) model from `metafor`.
...
```{r pQTLs, fig.cap="Genomic associations", fig.height=8.07, fig.width=7.08, messages=FALSE, results="hide", warnings=FALSE}
