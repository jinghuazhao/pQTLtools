...
ggplot(gwas_stats_hg38, aes(x = position, y = LP)) + geom_point() + ggtitle(with(sentinel,paste0(prot,"-",SNP," association plot")))
rds <- readRDS(f)
...
```{r run_TwoSampleMR, fig.height=8, fig.width=7, results='hide', warning=FALSE}
library(TwoSampleMR)
