...
The `merge_cvt` object is obtained for later use. 
...
The circos plot is based on target gene (encoding proteins) and somewhat too busy.

## *SH2B3*

Here we focus on the ***SH2B3***.
