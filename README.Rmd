...
this early stage, the repository contains 1. a number of
...
2. query results on genes, regions, and SNPs via PhenoScanner, adding
functionality to check for replication across platforms; 4. aspects
...
4. showcase of Bioconductor analyses and snakemake workflow.
