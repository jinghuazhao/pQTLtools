...
This figure starts with a default and is updated when selected for one
of the two alternatives.

``` r
htmltools::tags$iframe(src = "/pQTLtools/articles/lz.html", width = "100%", height = "600px")
```
...
### 1.2 Stacked association plots

The figure below extends to three panels.

``` r
htmltools::tags$iframe(src = "/pQTLtools/articles/stack.html", width = "100%", height = "600px")
```
...
-   `lz.html`,
    <https://jinghuazhao.github.io/pQTLtools/articles/lz.html>.
-   `stack.html`,
...
where options for protein GWAS, microarray, RNA-Seq are available with
respect to variant-flanking or gene regions. When no results are
...
Kamat, M. A. *et al.* [PhenoScanner V2: An expanded tool for searching
human genotype-phenotype
associations](https://doi.org/10.1093/bioinformatics/btz469).
