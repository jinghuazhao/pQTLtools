# SCALLOP-Caprion scripts

This article provides details of pQTL/disease overlap and colocalization
analysis.

## 1 SCALLOP analysis

### 1.1 pQTL/disease overlap
