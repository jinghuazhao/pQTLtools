...
##     jobid: 2
##     reason: Missing output files: output/MR.csv; Input files updated by another job: output/MR/MCP-1.csv, output/MR/CXCL1.csv, output/MR/MMP-1.csv, output/MR/Beta-NGF.csv, output/MR/CCL20.csv, output/MR/IL-18.csv, output/MR/CX3CL1.csv, output/MR/CSF-1.csv, output/MR/SIRT2.csv, output/MR/TRANCE.csv, output/MR/CCL3.csv, output/MR/CASP-8.csv, output/MR/OPG.csv, output/MR/CD40.csv, output/MR/HGF.csv, output/MR/IL-6.csv, output/MR/SCF.csv, output/MR/IL-8.csv, output/MR/CCL4.csv, output/MR/VEGF-A.csv, output/MR/FGF-23.csv, output/MR/MMP-10.csv, output/MR/CXCL6.csv, output/MR/TNFSF14.csv, output/MR/EN-RAGE.csv, output/MR/TRAIL.csv
##     resources: tmpdir=/rds/user/jhz22/hpc-work/work
## 
## 
## [Fri Jul 29 13:13:46 2022]
...
## [Fri Jul 29 13:13:52 2022]
## Finished job 1.
## 1 of 29 steps (3%) done
## Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.[Fri Jul 29 13:13:53 2022]
## Finished job 23.
## 2 of 29 steps (7%) done
## Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.[Fri Jul 29 13:13:54 2022]
## Finished job 18.
## 3 of 29 steps (10%) done
## [Fri Jul 29 13:13:54 2022]
## Finished job 4.
## 4 of 29 steps (14%) done
## Method requires data on >2 variants.[Fri Jul 29 13:13:54 2022]
## Finished job 16.
...
## ℹ The warning occurred in group 24: r2_thresh = 0.4, P_thresh = 1, Protein =
##   "MMP-10". 
## [Fri Jul 29 13:13:58 2022]
## Finished job 26.
## 25 of 29 steps (86%) done
## [Fri Jul 29 13:13:58 2022]
## Finished job 21.
## 26 of 29 steps (90%) done
## [Fri Jul 29 13:13:59 2022]
## Finished job 25.
...
##     output: output/MR.csv
##     jobid: 2
##     reason: Missing output files: output/MR.csv; Input files updated by another job: output/MR/EN-RAGE.csv, output/MR/CXCL1.csv, output/MR/CCL3.csv, output/MR/MCP-1.csv, output/MR/IL-6.csv, output/MR/IL-8.csv, output/MR/MMP-10.csv, output/MR/CCL20.csv, output/MR/CXCL6.csv, output/MR/VEGF-A.csv, output/MR/CCL4.csv, output/MR/CX3CL1.csv, output/MR/TNFSF14.csv, output/MR/TRANCE.csv, output/MR/CASP-8.csv, output/MR/OPG.csv, output/MR/TRAIL.csv, output/MR/HGF.csv, output/MR/MMP-1.csv, output/MR/IL-18.csv, output/MR/SCF.csv, output/MR/SIRT2.csv, output/MR/CSF-1.csv, output/MR/FGF-23.csv, output/MR/CD40.csv, output/MR/Beta-NGF.csv
##     resources: tmpdir=/rds/user/jhz22/hpc-work/work
## 
## [Fri Jul 29 13:13:59 2022]
## Finished job 2.
...
## Complete log: .snakemake/log/2022-07-29T131347.152521.snakemake.log
```
