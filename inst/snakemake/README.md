...
##     jobid: 2
##     reason: Missing output files: output/MR_aggregate.csv; Input files updated by another job: output/MR/FGF-23.csv, output/MR/TRANCE.csv, output/MR/TNFSF14.csv, output/MR/CXCL1.csv, output/MR/OPG.csv, output/MR/CXCL6.csv, output/MR/IL-6.csv, output/MR/IL-8.csv, output/MR/CD40.csv, output/MR/EN-RAGE.csv, output/MR/MCP-1.csv, output/MR/MMP-1.csv, output/MR/CCL3.csv, output/MR/Beta-NGF.csv, output/MR/CCL4.csv, output/MR/TRAIL.csv, output/MR/MMP-10.csv, output/MR/VEGF-A.csv, output/MR/HGF.csv, output/MR/SIRT2.csv, output/MR/CSF-1.csv, output/MR/SCF.csv, output/MR/CCL20.csv, output/MR/CASP-8.csv, output/MR/IL-18.csv, output/MR/CX3CL1.csv
##     resources: tmpdir=/rds/user/jhz22/hpc-work/work
## 
## 
## [Fri Jul 29 11:17:37 2022]
...
## [Fri Jul 29 11:17:58 2022]
## Finished job 1.
## 1 of 29 steps (3%) done
## Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.Method requires data on >2 variants.[Fri Jul 29 11:18:01 2022]
## Finished job 23.
## 2 of 29 steps (7%) done
## Method requires data on >2 variants.Method requires data on >2 variants.[Fri Jul 29 11:18:01 2022]
## Finished job 18.
## 3 of 29 steps (10%) done
## [Fri Jul 29 11:18:01 2022]
## Finished job 4.
## 4 of 29 steps (14%) done
## Method requires data on >2 variants.[Fri Jul 29 11:18:01 2022]
## Finished job 16.
...
## ℹ The warning occurred in group 30: r2_thresh = 0.6, P_thresh = 1, Protein =
##   "OPG". 
## Method requires data on >2 variants.Warning message:
...
##     output: output/MR_aggregate.csv
##     jobid: 2
##     reason: Missing output files: output/MR_aggregate.csv; Input files updated by another job: output/MR/TRANCE.csv, output/MR/CCL3.csv, output/MR/VEGF-A.csv, output/MR/IL-18.csv, output/MR/TRAIL.csv, output/MR/SCF.csv, output/MR/Beta-NGF.csv, output/MR/CASP-8.csv, output/MR/CX3CL1.csv, output/MR/IL-8.csv, output/MR/CCL20.csv, output/MR/CCL4.csv, output/MR/HGF.csv, output/MR/IL-6.csv, output/MR/CXCL6.csv, output/MR/CSF-1.csv, output/MR/FGF-23.csv, output/MR/EN-RAGE.csv, output/MR/SIRT2.csv, output/MR/MMP-10.csv, output/MR/OPG.csv, output/MR/MMP-1.csv, output/MR/CD40.csv, output/MR/TNFSF14.csv, output/MR/MCP-1.csv, output/MR/CXCL1.csv
##     resources: tmpdir=/rds/user/jhz22/hpc-work/work
## 
## [Fri Jul 29 11:18:06 2022]
## Finished job 2.
...
## Complete log: .snakemake/log/2022-07-29T111739.211383.snakemake.log
```
